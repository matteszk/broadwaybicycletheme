...
<div class="relative vh-header">
  <div class="absolute bg--fixed cover h100 bg-bottom" style="background-image: url('images/rack.jpg');"></div>
</div>

<div class="row relative mt3">
  <div class="col-xs-3 col-xs-offset-1 bg-red">
    <h1 class="tr"><span class="tilt-l">Sales</span> &amp; <span class="tilt-r">Rentals</span></h1>
  ...
  <div class="row col-xs-7 col-lg-5 col-xs-offset-1 middle-xs">
    <a class="pa-grid col-xs-6 col-sm-4" href="http://www.surly.com">
      <img alt="" src="<?php bloginfo('template_url'); ?>/images/logo-surly.png"/>
    </a>
    <a class="pa-grid col-xs-6 col-sm-4" href="http://www.marin.com">
      <img alt="" src="<?php bloginfo('template_url'); ?>/images/logo-marin.png"/>
    </a>
    <a class="pa-grid col-xs-6 col-sm-4" href="http://sim-works.com/">
      <img alt="" src="<?php bloginfo('template_url'); ?>/images/logo-simworks.png"/>
    </a>
    <a class="pa-grid col-xs-6 col-sm-4" href="http://www..com">
      <img alt="" src="<?php bloginfo('template_url'); ?>/images/logo-compass.png"/>
    </a>
    <a class="pa-grid col-xs-6 col-sm-4" href="https://crustbikes.com">
      <img alt="" src="<?php bloginfo('template_url'); ?>/images/logo-crust.svg"/>
    </a>
    <a class="pa-grid col-xs-6 col-sm-4" href="https://paulcomp.com/">
      <img alt="" src="<?php bloginfo('template_url'); ?>/images/logo-paul.svg"/>
    </a>
    <a class="pa-grid col-xs-6 col-sm-4" href="http://www..com">
      <img alt="" src="<?php bloginfo('template_url'); ?>/images/logo-all-city.png"/>
    </a>
    <a class="pa-grid col-xs-6 col-sm-4" href="http://www..com">
      <img alt="" src="<?php bloginfo('template_url'); ?>/images/logo-brooklyn-bicycle-co.png"/>
    </a>
    <a class="pa-grid col-xs-6 col-sm-4" href="http://www..com">
      <img alt="" src="<?php bloginfo('template_url'); ?>/images/logo-brompton.png"/>
    </a>
    <a class="pa-grid col-xs-6 col-sm-4" href="http://www..com">
      <img alt="" src="<?php bloginfo('template_url'); ?>/images/logo-velo-orange.png"/>
    </a>
  </div>
