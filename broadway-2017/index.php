...
if (have_posts()) : while (have_posts()) : the_post();?>
			...
			<p><span class="author">Posted on <?php the_time('F jS, Y'); ?> by <?php the_author(); ?></span><br />
					<?php the_tags('Tags: ', ', ', '<br>'); ?> Read all <?php the_category(', '); ?> &bull; <?php edit_post_link('Edit', '', ' &bull; '); ?> </p>
