	...
	<?php if(wpsc_display_categories()): ?>
	  ...
	  <?php else:?>
            ...
            <li><h3>Categories</h3></li>
				...
				<?php wpsc_end_category_query(); ?>
            <li> <?php echo wpsc_shopping_cart(); ?></li>
            <li>Find out what you can <a href="/products-page/buy-online/">buy online</a>!</li>
			</ul>
		<?php endif; ?>
	<?php endif; ?>
<?php // */ ?>
			...
			<div class="default_product_display product_view_<?php echo wpsc_the_product_id(); ?> <?php echo wpsc_category_class(); ?> group">   
				...
				<?php if(wpsc_show_thumbnails()) :?>
                    ...
                    <h2 class="prodtitle entry-title">
							...
							<?php else: ?> 
								<a class="wpsc_product_title" href="<?php echo wpsc_the_product_permalink(); ?>"><?php echo wpsc_the_product_title(); ?></a></h2>  
                            <p class="prodDetails"> <a class="wpsc_product_title" href="<?php echo wpsc_the_product_permalink(); ?>"> More Details &raquo;</a>  </p> 
